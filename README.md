...
# Les valeurs de la DB sont par défaut : root et root pour username et password.
cp .env.example .env


# Lancer le serveur local (localhost:8000)
npm run dev
php artisan serve

# Lien de notre version "production" : 
https://projet-cyedin-production.up.railway.app/
```

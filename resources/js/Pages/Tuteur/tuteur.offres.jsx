...
export default function TuteurOffres({ offres = [], secteurs = [], filters = {} }) {
            ...
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-4 mb-6">
                <div className="flex flex-wrap gap-3">
                    ...
                    <select
                        ...
                        className="border border-slate-200 rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-teal-100"
                    >

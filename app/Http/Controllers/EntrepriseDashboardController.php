...
{
    $entreprise = $this->entreprise();
    $offres = $entreprise->offres()->with('tags')->withCount('candidatures')->orderBy('created_at', 'desc')->get();
    ...
    // ─── Store offre ─────────────────────────────────────────
    public function store_offre(Request $request, OffreService $offreService): RedirectResponse
{
    $request->validate([
    ...
    $offre = Offre::create([  // ← $offre assignée ici, manquait dans ta version
        'titre'          => $request->titre,
